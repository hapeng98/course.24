...
if (isset($_POST['foreign_2-2'])) {
    $selected = $_POST['foreign_2-2'];
    $stunum = $_SESSION['stunum']; 
    
    $resetQuery = "UPDATE course24_2_2 SET 일본어Ⅰ=NULL, 중국어Ⅰ=NULL WHERE stunum=?";
    ...
    $column = $selected;
    $query = "UPDATE course24_2_2 SET $column=1 WHERE stunum=?";
